...
extern void DVTask(void const * argument);
extern void ComTask(void const * argument);
extern void CanSendTask(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(Communication, ComTask, osPriorityNormal, 0, 512);
  CommunicationHandle = osThreadCreate(osThread(Communication), NULL);

  /* definition and creation of CanSend */
  osThreadDef(CanSend, CanSendTask, osPriorityRealtime, 0, 512);
